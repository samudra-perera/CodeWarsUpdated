...
function comp(array1, array2){
    ...
    let sqaureArr1 = array1.sort((a,b) => a-b).map(elem => (elem**2).toString()).join('')
...
let comp = (array1, array2) => {
    ...
    array1.sort((a,b) => a-b)
    array2.sort((a,b) => a-b)
    let counter = array1.map((e,i) => (e**2 == array2[i]) ? e = 1 : e = 0)
    return counter.reduce((a,c) => a+c, 0) == array1.length
}
